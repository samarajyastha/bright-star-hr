...
<head>
    ...
    <!-- Page Title -->
    <title>Jackcerra - Business HTML5 Template</title>
...
<body>
    ...
    <div class="page-wrapper">
                ...
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="right-box d-flex align-items-center">
                            <ul class="info-list">
                                <li><a href="mailto:jackcerra@gmail.com"><span class="icon fa fa-envelope"></span>jackcerra@gmail.com</a></li>
                                <li><a href="#"><span class="icon fa fa-map-marker"></span>231 madison Street, NewYork,USA</a></li>
                            </ul>

                            <!-- Button Box -->
                            <div class="button-box d-none d-lg-flex">
                                <a href="contact.html" class="btn clearfix">
                                    <span class="btn-wrap">
                                        <span class="text-one">Get Free Quote</span>
                                        <span class="text-two">Get Free Quote</span>
                                    </span>
                                </a>
                            </div>
                        </div>
            ...
            <div class="header-lower">
                ...
                <div class="container">
                    <div class="inner-container d-flex justify-content-between align-items-center">
                        ...
                        <div class="logo-box">
                            <!-- Logo -->
                            <div class="logo"><a href="index.html"><img src="<?php bloginfo('template_directory'); ?>/assets/images/logo.svg" alt="img" title=""></a></div>
                        </div>
                            ...
                            <div class="outer-box d-flex align-items-center">
                                ...
                                <div class="header_search d-none d-sm-block">
                                    <form class="search_form" action="search.php">
                                        ...
                                        <button type="submit" class="form-control-submit"><img src="<?php bloginfo('template_directory'); ?>/assets/images/icons/search.png" alt="img"></button>
                                    </form>
                                </div>

                                <!-- Aside Panel -->
                                <a href="#" class="aside_open d-none d-sm-block"><img src="<?php bloginfo('template_directory'); ?>/assets/images/icons/menu.png" alt="img"></a>
        ...
        <div class="aside_info">
            ...
            <div class="logo-side">
                <a href="index.html">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/logo.svg" alt="img">
                </a>
            </div>
